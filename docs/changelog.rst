...
- Part A–C: design sourcing (1,041 designs across 4 strategies), PenScore computation,
  ESMFold structural predictions, MHCflurry 2.2.1 immunogenicity scoring.
- Part D: eight-gate triage (1,029 survivors), bootstrap rank stability,
  diversity analysis, failure-mode analysis.
- Part E: five pre-registered formal prediction tests (all PASS).
- Part F: public catalog — CSV/Parquet scorecard, FASTA files, 1,029 per-design JSONs,
