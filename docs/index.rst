...
Part of `PEN-STACK <https://github.com/ahmedanees-m>`_:
...
.. note::
   All five pre-registered predictions **PASS** (5/5). 16 designs beat IS621 verbatim lockpoint (PenScore > 0.929). See :doc:`predictions`.
