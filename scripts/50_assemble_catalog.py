...
Note on PDB structures:
  ESMFold PDB files reside at ~/esm_tier1_output/pdbs/.
...
# Export columns (no tier_b/composite_flag/ddg in actual data)
CATALOG_COLS = [
...
def main() -> None:
    ...
    # 5. Structure note
    pdb_note = (
        "ESMFold PDB structures reside at "
        "~/esm_tier1_output/pdbs/. "
        "VM path per design is stored in the final_pdb column of "
        "pen_assemble_catalog.csv."
    )
