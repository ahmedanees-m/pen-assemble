...
MECH-CLASS's 31,871-protein IS110-triage catalog. All 992 designs passed PFAM gate
...
Note on Gate 8 (ATLAS embedding distance for literature novelty):
  Not evaluated in this run - GENOME-ATLAS ATLAS DuckDB access is pending.
...
def main() -> None:
    ...
    result = {
        ...
        "gate_8_atlas_novelty": {
            ...
            "reason": (
                "GENOME-ATLAS ATLAS DuckDB not accessible in this run. "
                "Strategy B sourced from MECH-CLASS's IS110-triage catalog with explicit "
