...
Run where the PDB files are stored:
...
# Paths (VM-relative)
PDB_DIR      = Path("~/esm_tier1_output/pdbs")
RESULTS_CSV  = Path("~/esm_tier1_output/step12_results.csv")
OUTPUT_DIR   = Path("~/esm_tier1_output")
