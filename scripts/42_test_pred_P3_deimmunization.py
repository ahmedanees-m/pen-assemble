...
IMPORTANT - documented methodology had placeholder WT_IS621_S_IMMUNO = 0.250 (incorrect).
Corrected to 0.7594, which is IS621's actual S_Immuno from PEN-SCORE v0.1.0.
...
WT_IS621_S_IMMUNO_PUBLISHED = 0.7594   # PEN-SCORE v0.1.0 (pre-registered reference)
...
def main() -> None:
    ...
    result = {
        ...
        "correction_note": (
            "Earlier placeholder WT_IS621_S_IMMUNO=0.250 was incorrect. "
