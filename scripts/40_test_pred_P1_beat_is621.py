...
This is the headline claim of PEN-ASSEMBLE. The pre-registered threshold is PenScore > 0.929,
which equals IS621's published score in PEN-SCORE v0.1.0 (rounded from 0.9290).
...
IS621_PEN_SCORE_VERBATIM   = 0.929    # pre-registered
...
def main() -> None:
    ...
    result = {
        ...
        "calibration_note": (
            "IS621 S_Immuno published=0.7594 (PEN-SCORE older MHCflurry) vs 0.7243 (MHCflurry 2.2.1). "
            "Calibrated lockpoint = 0.9290 + (0.7243-0.7594)*0.10 = 0.9255. "
